---
title: Quick Start
description: Install or build the CLI, configure a home, add a plugin, install a version, and activate your shell.
---

This guide walks through the fastest path from a clean checkout or a published release to a working `vs` setup.

## 1. Install a published release or build the CLI

If you just want to install `vs`, use one of the release installers:
...
If you are developing from source instead, build the default CLI binary from the workspace root:
